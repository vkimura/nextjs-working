...
const Portfolio = () => {
  return (
    <div className="max-w-[1240px] m-auto py-2 text-center">
      <h1 className="text-2xl font-bold p4">My Portfolio</h1>
      <div className="grid grid-rows-none gap-3 p-4 sm:gap-y-3 md:gap-4 md:grid-cols-5 lg:grid-cols-3">
